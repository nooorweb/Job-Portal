    ...
    <article className="pk-card pk-card-hoverable overflow-hidden flex flex-col group">
      <div className="relative h-44 overflow-hidden">
        ...
        <button
          ...
          onClick={(e) => {
            e.preventDefault();
            setBookmarks(isBookmarked ? bookmarks.filter((b) => b !== org.slug) : [...bookmarks, org.slug]);
          }}
      ...
      <div className="p-5 flex-1 flex flex-col">
        ...
        <div className="flex flex-wrap gap-1.5 mb-4">
          {org.tags.slice(0, 3).map((t) => (
            <span key={t} className="pk-pill !text-[11px] !py-0.5">{t}</span>
          ))}
        </div>
        ...
        <div className="mt-auto flex items-center justify-between pt-3 border-t border-[var(--color-border-light)]">
          ...
          <Link
            ...
            className="pk-btn pk-btn-outline !py-2 !px-3 !text-[13px]"
          >
